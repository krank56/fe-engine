...
fn test_cpu_gpu_bit_exact_equality_simple_beam() {
    ...
    #[cfg(all(target_os = "macos", feature = "gpu"))]
    {
        ...
        for cpu_disp in &_cpu_result.displacements {
            let gpu_disp = _gpu_result.displacements.iter()
                .find(|d| d.node_id == cpu_disp.node_id)
                .expect(&format!("GPU result missing displacement for node {}", cpu_disp.node_id));

            assert!(
                (cpu_disp.translation.x - gpu_disp.translation.x).abs() < disp_tolerance,
                "Node {} UX: CPU={:.16e} vs GPU={:.16e} (diff={:.16e})", 
                cpu_disp.node_id, cpu_disp.translation.x, gpu_disp.translation.x,
            ...
            assert!(
                ...
                cpu_disp.node_id, cpu_disp.translation.y, gpu_disp.translation.y,
            ...
            assert!(
                ...
                cpu_disp.node_id, cpu_disp.translation.z, gpu_disp.translation.z,
            ...
            assert!(
                ...
                cpu_disp.node_id, cpu_disp.rotation.x, gpu_disp.rotation.x,
            ...
            assert!(
                ...
                cpu_disp.node_id, cpu_disp.rotation.y, gpu_disp.rotation.y,
        ...
        for cpu_rxn in &_cpu_result.reactions {
            ...
            assert!(
                ...
                cpu_rxn.node_id, cpu_rxn.force.y, gpu_rxn.force.y,
            ...
            assert!(
                ...
                cpu_rxn.node_id, cpu_rxn.force.z, gpu_rxn.force.z,
